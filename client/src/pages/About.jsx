...
const About = () => {
  ...
  return (
    <div className="bg-white">
      ...
      <section
        ref={heroRef}
        className="relative flex h-[calc(100vh-88px)] min-h-[620px] items-center overflow-hidden bg-[#0f172a] py-10 text-center text-white md:py-12"
      >
        <video
        ...
        <div className="container relative z-10 mx-auto flex h-full max-w-6xl flex-col items-center justify-center px-6">
          <div className="hero-text mb-3 inline-flex items-center gap-2 rounded-full border border-blue-800 bg-blue-900/30 px-4 py-1.5 text-[11px] font-bold uppercase tracking-widest text-blue-200">
            <span className="w-2 h-2 rounded-full bg-blue-400"></span>
            About Us
          </div>

          <h1 className="hero-text mb-3 text-[2.85rem] font-black leading-[1] sm:text-5xl md:text-[4.25rem] lg:text-[5.1rem]">
            Building{' '}
