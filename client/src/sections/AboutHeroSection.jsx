...
const AboutHeroSection = () => {
    ...
    return (
        <section ref={containerRef} className="relative pt-8 pb-12 md:pt-10 md:pb-16 flex items-center justify-center overflow-hidden bg-white text-gray-900">
            ...
            <div className="container mx-auto px-6 max-w-7xl relative z-10">
                {/* Heading */}
                <div ref={headingRef} className="text-center mb-6 md:mb-7">
                ...
                {/* Two Column Layout */}
                <div className="grid md:grid-cols-2 gap-8 md:gap-10 mb-5 md:mb-6">
                    {/* Left Column - Story */}
                    <div ref={leftRef} className="space-y-5">
                        ...
                        <div className="mt-5 flex gap-3">
                            <div className="flex-1 p-3.5 bg-blue-50 border border-blue-100 rounded-lg">
                            ...
                            <div className="flex-1 p-3.5 bg-purple-50 border border-purple-100 rounded-lg">
                            ...
                            <div className="flex-1 p-3.5 bg-indigo-50 border border-indigo-100 rounded-lg">
                        ...
                        {/* Mission Badge */}
                        <div className="relative mt-5 p-5 bg-gradient-to-br from-blue-600 via-indigo-600 to-purple-600 rounded-2xl text-white shadow-xl">
                    ...
                    <div ref={rightRef} className="space-y-5">
                        ...
                        {values.map((value, i) => (
                            <div key={i} className="p-4 bg-white border border-gray-200 rounded-xl shadow-sm hover:shadow-md hover:border-blue-200 transition-shadow duration-300 group">
                        ...
                        <div className="mt-5 p-5 bg-gray-50 rounded-xl border border-gray-100">
                            <h4 className="text-sm font-bold text-gray-900 mb-3 uppercase tracking-wider">We Partner With:</h4>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-5">
                    {stats.map((stat, i) => (
                        <div key={i} ref={el => statsRef.current[i] = el} className="text-center p-5 bg-gradient-to-br from-gray-50 to-white border border-gray-100 rounded-xl shadow-sm hover:shadow-md transition-shadow duration-300">
