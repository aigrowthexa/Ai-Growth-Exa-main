...
const TestimonialsSection = () => {
    ...
    return (
        <section className="pt-6 pb-8 md:pt-8 md:pb-10 bg-white overflow-hidden relative">
            {/* Neuron Particle Effect Background */}
            <FloatingParticles theme="light" />

            <div className="container mx-auto px-6 mb-4 md:mb-5 text-center relative z-10">
            ...
            <div className="relative w-full overflow-hidden" ref={containerRef}>
                ...
                <div className="absolute top-0 left-0 w-10 md:w-16 h-full bg-gradient-to-r from-white to-transparent z-10 pointer-events-none"></div>
                <div className="absolute top-0 right-0 w-10 md:w-16 h-full bg-gradient-to-l from-white to-transparent z-10 pointer-events-none"></div>
                ...
                >
                    {[...testimonials, ...testimonials].map((testimonial, index) => (
                        <div
                            ...
                            className="w-[260px] sm:w-[280px] lg:w-[300px] mx-3 p-5 rounded-2xl bg-white border border-gray-200 shadow-lg hover:shadow-xl transition-shadow duration-300 group flex-shrink-0 select-none"
                        >
